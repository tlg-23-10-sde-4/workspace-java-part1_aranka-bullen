...
class TelevisionClient {
    ...
    public static void main(String[] args) {
        ...
        // create an instance of Television and set it properties via the 2-arg ctor
        Television tv2 = new Television("Sony", Television.MIN_VOLUME);

        // Create an instance of Television and set it properties via 1-arg ctor
        Television tv3 = new Television("LG");

       // create an instance of Television and set its properties
        Television tv4 = new Television("Toshiba", 60,DisplayType.OLED );
