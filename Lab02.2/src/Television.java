/*
 * This is the business class to model the workings of a Television.
 */
...
class Television {
    ...
    public Television(String brand) {  // 1-arg ctor
        this();    // delegates the execution of the instanceCount field of the no-arg ctor
        setBrand(brand);
    }
    public Television(String brand, int volume){  // 2-arg ctor.  The "brand" instance variable is delegate to
    ...
    //
    // functions or operations - aka " action methods" in Java. What do Television do?
    public void turnOn() {
    ...
    public void setBrand(String brand) {
        switch (brand){
            ...
            case "Sony":
                ...
                break;
            default:
                System.out.printf("The brand %s is an INVALID Brand.", brand);
                break;
        }
    }
...
//            System.out.println("The input volume: " + volume +" is NOT VALID. Valid entries is between "
//                    + MIN_VOLUME + " - " + MAX_VOLUME + ".");
    ...
    public String toString() {
        ...
        return String.format(" %s Television: brand=%s, volume=%s, display=%s.", getClass(), getBrand(),
